...
static  int vmnc_get_pixel(GetByteContext *gb, int bpp, int be)
{
    switch (bpp * 2 + be) {
    case 2:
    case 3:
...
static  void paint_rect(uint8_t *dst, int dx, int dy,
...
static  void paint_raw(uint8_t *dst, int w, int h,
