...
static  int dv_rl2vlc(int run, int level, int sign,
                                      uint32_t *vlc)
{
    int size;
...
static  int dv_rl2vlc_size(int run, int level)
{
    int size;
...
#else
static  int dv_rl2vlc(int run, int l, int sign, uint32_t *vlc)
{
    *vlc = dv_vlc_map[run][l].vlc | sign;
    return dv_vlc_map[run][l].size;
}

static  int dv_rl2vlc_size(int run, int l)
{
    return dv_vlc_map[run][l].size;
}
#endif
...
static  PutBitContext *dv_encode_ac(EncBlockInfo *bi,
...
static  int dv_guess_dct_mode(DVVideoContext *s, uint8_t *data,
                                              ptrdiff_t linesize)
{
...
static  int dv_init_enc_block(EncBlockInfo *bi, uint8_t *data,
                                              ptrdiff_t linesize,
