...
/* the following codec id fields are deprecated in favor of codec_id */
    ...
    MpegPicture *picture;          ///< main picture buffer
    MpegPicture **input_picture;   ///< next pictures on display order for encoding
    MpegPicture **reordered_input_picture; ///< pointer to the next pictures in coded order for encoding
     ...
     */
    MpegPicture last_picture;

    /**
     * copy of the next picture structure.
     * note, linesize & data, might not match the next picture (for field pictures)
     */
    MpegPicture next_picture;

    /**
     * copy of the source picture structure for encoding.
     * note, linesize & data, might not match the source picture (for field pictures)
     */
    MpegPicture new_picture;

    /**
     * copy of the current picture structure.
     * note, linesize & data, might not match the current picture (for field pictures)
     */
    MpegPicture current_picture;    ///< buffer to store the decompressed current picture

    MpegPicture *last_picture_ptr;     ///< pointer to the previous picture.
    MpegPicture *next_picture_ptr;     ///< pointer to the next picture (for bidir pred)
    MpegPicture *current_picture_ptr;  ///< pointer to the current picture
...
void ff_print_debug_info(MpegEncContext *s, MpegPicture *p, AVFrame *pict);

int ff_mpv_export_qp_table(MpegEncContext *s, AVFrame *f, MpegPicture *p, int qp_type);
