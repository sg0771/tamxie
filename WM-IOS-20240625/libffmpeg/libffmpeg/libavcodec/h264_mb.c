...
static  void mc_dir_part(const H264Context *h, H264SliceContext *sl,
                                         H264Ref *pic,
...
static  void mc_part_std(const H264Context *h, H264SliceContext *sl,
                                         int n, int square,
...
static  void mc_part_weighted(const H264Context *h, H264SliceContext *sl,
                                              int n, int square,
                                              int height, int delta,
                                              uint8_t *dest_y, uint8_t *dest_cb,
                                              uint8_t *dest_cr,
...
static  void prefetch_motion(const H264Context *h, H264SliceContext *sl,
...
static  void xchg_mb_border(const H264Context *h, H264SliceContext *sl,
                                            uint8_t *src_y,
...
static  int dctcoef_get(int16_t *mb, int high_bit_depth,
                                        int index)
{
    if (high_bit_depth) {
...
static  void dctcoef_set(int16_t *mb, int high_bit_depth,
                                         int index, int value)
{
    if (high_bit_depth) {
...
static  void hl_decode_mb_predict_luma(const H264Context *h,
                                                       H264SliceContext *sl,
...
static  void hl_decode_mb_idct_luma(const H264Context *h, H264SliceContext *sl,
                                                    int mb_type, int simple,
                                                    int transform_bypass,
                                                    int pixel_shift,
                                                    const int *block_offset,
