...
static int make_tables_writable(MpegPicture *pic)
{
    int ret, i;
 ...
 */
static int alloc_frame_buffer(AVCodecContext *avctx,  MpegPicture *pic,
...
static int alloc_picture_tables(AVCodecContext *avctx, MpegPicture *pic, int encoding, int out_format,
 ...
 */
int ff_alloc_picture(AVCodecContext *avctx, MpegPicture *pic, MotionEstContext *me,
 ...
 */
void ff_mpeg_unref_picture(AVCodecContext *avctx, MpegPicture *pic)
{
    int off = offsetof(MpegPicture, mb_mean) + sizeof(pic->mb_mean);
...
int ff_update_picture_tables(MpegPicture *dst, MpegPicture *src)
{
     int i;
...
int ff_mpeg_ref_picture(AVCodecContext *avctx, MpegPicture *dst, MpegPicture *src)
{
    int ret;
...
static inline int pic_is_unused(MpegPicture *pic)
{
    if (!pic->f->buf[0])
        return 1;
...
static int find_unused_picture(AVCodecContext *avctx, MpegPicture *picture, int shared)
{
    int i;
...
int ff_find_unused_picture(AVCodecContext *avctx, MpegPicture *picture, int shared)
{
...
void ff_free_picture_tables(MpegPicture *pic)
{
    int i;
