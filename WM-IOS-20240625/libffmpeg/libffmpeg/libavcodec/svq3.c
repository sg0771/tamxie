 ...
 */
static  void svq3_pred_motion(const SVQ3Context *s, int n,
...
static  void hl_decode_mb_idct_luma(SVQ3Context *s,
...
static  void hl_decode_mb_predict_luma(SVQ3Context *s,
                                                       int mb_type,
