...
static  void vc1_scale_luma(uint8_t *srcY,
                                            int k, int linesize)
{
    int i, j;
    for (j = 0; j < k; j++) {
...
static  void vc1_scale_chroma(uint8_t *srcU, uint8_t *srcV,
...
static  void vc1_lut_scale_luma(uint8_t *srcY,
...
static  void vc1_lut_scale_chroma(uint8_t *srcU, uint8_t *srcV,
                                                  uint8_t *lut1, uint8_t *lut2,
                                                  int k, int uvlinesize)
{
    int i, j;
