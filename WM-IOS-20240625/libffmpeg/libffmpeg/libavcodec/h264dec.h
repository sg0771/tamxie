...
static  uint32_t pack16to32(unsigned a, unsigned b)
{
#if HAVE_BIGENDIAN
...
static  uint16_t pack8to16(unsigned a, unsigned b)
{
#if HAVE_BIGENDIAN
    return (b & 0xFF) + (a << 8);
#else
 ...
 * Get the chroma qp.
 */
static  int get_chroma_qp(const PPS *pps, int t, int qscale)
{
 ...
 */
static  int pred_intra_mode(const H264Context *h,
...
static  void write_back_intra_pred_mode(const H264Context *h,
                                                        H264SliceContext *sl)
{
...
static  void write_back_non_zero_count(const H264Context *h,
                                                       H264SliceContext *sl)
{
...
static  void write_back_motion_list(const H264Context *h,
                                                    H264SliceContext *sl,
                                                    int b_stride,
                                                    int b_xy, int b8_xy,
...
static  void write_back_motion(const H264Context *h,
                                               H264SliceContext *sl,
                                               int mb_type)
{
...
static  int get_dct8x8_allowed(const H264Context *h, H264SliceContext *sl)
{
