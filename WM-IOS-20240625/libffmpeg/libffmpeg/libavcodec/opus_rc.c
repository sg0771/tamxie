...
static  void opus_rc_enc_carryout(OpusRangeCoder *rc, int cbuf)
{
...
static  void opus_rc_dec_normalize(OpusRangeCoder *rc)
{
...
static  void opus_rc_enc_normalize(OpusRangeCoder *rc)
{
    while (rc->range <= OPUS_RC_BOT) {
...
static  void opus_rc_dec_update(OpusRangeCoder *rc, uint32_t scale,
...
static  void opus_rc_enc_update(OpusRangeCoder *rc, uint32_t b, uint32_t p,
