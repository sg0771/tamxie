...
static inline av_const int avpriv_isinff(float x)
{
...
static inline av_const int avpriv_isinf(double x)
{
...
#if !HAVE_ISNAN
static inline av_const int avpriv_isnanf(float x)
{
    uint32_t v = av_float2int(x);
    if ((v & 0x7f800000) != 0x7f800000)
        return 0;
...
static inline av_const int avpriv_isnan(double x)
{
    uint64_t v = av_double2int(x);
    if ((v & 0x7ff0000000000000) != 0x7ff0000000000000)
        return 0;
...
#if !HAVE_ISFINITE
static inline av_const int avpriv_isfinitef(float x)
{
    uint32_t v = av_float2int(x);
    return (v & 0x7f800000) != 0x7f800000;
}

static inline av_const int avpriv_isfinite(double x)
{
    uint64_t v = av_double2int(x);
...
#define HAVE_LRINT 1
#if !HAVE_LRINT
static  av_const long int lrint(double x)
{
    return rint(x);
}
#endif /* HAVE_LRINT */
...
#if !HAVE_LRINTF
static  av_const long int lrintf(float x)
{
    return (int)(rint(x));
}
#endif /* HAVE_LRINTF */
...
#define HAVE_ROUND 1
#if !HAVE_ROUND
static  av_const double round(double x)
{
    return (x > 0) ? floor(x + 0.5) : ceil(x - 0.5);
}
#endif /* HAVE_ROUND */
...
#if !HAVE_ROUNDF
static  av_const float roundf(float x)
{
    return (x > 0) ? floor(x + 0.5) : ceil(x - 0.5);
}
#endif /* HAVE_ROUNDF */
...
#define HAVE_TRUNC 1
#if !HAVE_TRUNC
static  av_const double trunc(double x)
{
...
#if !HAVE_TRUNCF
static  av_const float truncf(float x)
{
    return (x > 0) ? floor(x) : ceil(x);
}
#endif /* HAVE_TRUNCF */
