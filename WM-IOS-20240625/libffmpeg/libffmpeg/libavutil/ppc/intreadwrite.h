...
static  uint16_t av_read_bswap16(const void *p)
{
    uint16_t v;
...
static  void av_write_bswap16(void *p, uint16_t v)
{
    __asm__ ("sthbrx  %1, %y0" : "=Z"(*(uint16_t*)p) : "r"(v));
}

static  uint32_t av_read_bswap32(const void *p)
{
    uint32_t v;
...
static  void av_write_bswap32(void *p, uint32_t v)
{
...
static  uint64_t av_read_bswap64(const void *p)
{
    uint64_t v;
...
static  void av_write_bswap64(void *p, uint64_t v)
{
