...
static  uint16_t AV_RB16(const void *p)
{
    uint16_t v;
    __asm__ ("loadacc,   (%1+) \n\t"
             "rol8             \n\t"
...
static  void AV_WB16(void *p, uint16_t v)
{
...
static  uint16_t AV_RL16(const void *p)
{
    uint16_t v;
    __asm__ ("loadacc,   (%1+) \n\t"
             "storeacc,  %0    \n\t"
...
static  void AV_WL16(void *p, uint16_t v)
{
    __asm__ volatile ("loadacc,   %1    \n\t"
                      "storeacc,  (%0+) \n\t"
                      "lsr8             \n\t"
...
static  void AV_WB32(void *p, uint32_t v)
{
...
static  uint32_t AV_RL32(const void *p)
{
    uint32_t v;
    __asm__ ("loadacc,   (%1+) \n\t"
             "storeacc,  %0    \n\t"
...
static  void AV_WL32(void *p, uint32_t v)
{
    __asm__ volatile ("loadacc,   %1    \n\t"
                      "storeacc,  (%0+) \n\t"
                      "lsr8             \n\t"
