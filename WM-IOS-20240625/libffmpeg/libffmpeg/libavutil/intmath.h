...
static  av_const int ff_log2_c(unsigned int v)
{
    int n = 0;
    if (v & 0xffff0000) {
        v >>= 16;
...
static  av_const int ff_log2_16bit_c(unsigned int v)
{
    int n = 0;
    if (v & 0xff00) {
        v >>= 8;
...
static  av_const int ff_ctz_c(int v)
{
...
/* We use the De-Bruijn method outlined in:
 * http://supertech.csail.mit.edu/papers/debruijn.pdf. */
static  av_const int ff_ctzll_c(long long v)
{
...
static  av_const unsigned ff_clz_c(unsigned x)
{
