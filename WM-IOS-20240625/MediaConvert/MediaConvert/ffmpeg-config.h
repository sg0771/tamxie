...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-static --disable-shared --prefix=win32-static --arch=x86 --target-os=mingw32 --enable-version3 --enable-libshine --enable-libopenjpeg --enable-sdl2 --enable-bzlib --enable-fontconfig --enable-gnutls --enable-iconv --enable-libass --enable-libbluray --enable-libfreetype --enable-libmp3lame --enable-librtmp --enable-libopus --enable-libsnappy --enable-libsoxr --enable-libtheora --enable-libtwolame --enable-libvpx --enable-libwavpack --enable-libwebp --enable-libx264 --enable-libx265 --enable-libzimg --enable-lzma --enable-zlib --enable-gmp --enable-libvidstab --enable-amf --enable-cuda --enable-cuvid --enable-d3d11va --enable-nvenc --enable-dxva2 --enable-avisynth --enable-libmfx --enable-frei0r --enable-filter=frei0r --enable-libcaca --enable-nonfree --enable-libfdk-aac --enable-libbs2b --enable-libilbc --enable-libopencore_amrwb --enable-libvo_amrwbenc --enable-libopencore_amrnb --enable-libopenh264 --enable-libgme --enable-libfribidi --enable-libxavs --enable-libxvid --enable-libspeex --enable-libvorbis --enable-libmodplug --enable-libtheora --enable-avisynth --disable-avresample --disable-postproc --disable-avdevice --disable-demuxer=matroska --extra-cflags=-I/usr/local/include --extra-libs='-ldl -lpsapi -L/usr/local/lib -lfrei0r -lm -lstdc++'"
...
#define CC_IDENT "gcc 7.2.0 (Rev1, Built by MSYS2 project)"
