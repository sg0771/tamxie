...
LOCAL_C_INCLUDES +=$(LOCAL_PATH)/libAACenc/include 
LOCAL_C_INCLUDES +=$(LOCAL_PATH)/libFDK/include 
LOCAL_C_INCLUDES +=$(LOCAL_PATH)/libMpegTPDec/include  
LOCAL_C_INCLUDES +=$(LOCAL_PATH)/libMpegTPEnc/include 
LOCAL_C_INCLUDES +=$(LOCAL_PATH)/libPCMutils/include 
LOCAL_C_INCLUDES +=$(LOCAL_PATH)/libSBRdec/include 
LOCAL_C_INCLUDES +=$(LOCAL_PATH)/libSBRenc/include 
LOCAL_C_INCLUDES +=$(LOCAL_PATH)/libSYS/include

LOCAL_CFLAGS :=-DPIC=1 -fPIC -fpic -Wshadow -O2 -ffast-math  -Wall -fpic -D_GNU_SOURCE -fPIC -fomit-frame-pointer -fno-tree-vectorize

LOCAL_SRC_FILES:=libAACdec/src/aac_ram.cpp \
