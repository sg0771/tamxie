...
static void Scale2D(
  ...
  switch (hratio * 10 / hscale) {
    case 8:
      ...
      horiz_line_scale = aom_horizontal_line_5_4_scale_c;
      break;
    case 6:
      /* 3-5 Scale in Width direction */
      horiz_line_scale = aom_horizontal_line_5_3_scale_c;
      break;
    case 5:
      /* 1-2 Scale in Width direction */
      horiz_line_scale = aom_horizontal_line_2_1_scale_c;
      break;
    default:
  ...
  switch (vratio * 10 / vscale) {
    case 8:
      ...
      vert_band_scale = aom_vertical_band_5_4_scale_c;
      source_band_height = 5;
      dest_band_height = 4;
      break;
    case 6:
      /* 3-5 Scale in vertical direction */
      vert_band_scale = aom_vertical_band_5_3_scale_c;
      source_band_height = 5;
      dest_band_height = 3;
      break;
    case 5:
      ...
      if (interlaced) {
        ...
        vert_band_scale = aom_vertical_band_2_1_scale_c;
      } else {
        interpolation = 1;
        /* if the content is progressive, interplo */
        vert_band_scale = aom_vertical_band_2_1_scale_i_c;
      }
