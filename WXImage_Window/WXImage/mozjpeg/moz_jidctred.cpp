...
GLOBAL(void)
moz_jpeg_idct_4x4(j_decompress_ptr cinfo, jpeg_component_info *compptr,
...
GLOBAL(void)
moz_jpeg_idct_2x2(j_decompress_ptr cinfo, jpeg_component_info *compptr,
              JCOEFPTR coef_block, JSAMPARRAY output_buf,
              JDIMENSION output_col)
{
  JLONG tmp0, tmp10, z1;
...
GLOBAL(void)
moz_jpeg_idct_1x1(j_decompress_ptr cinfo, jpeg_component_info *compptr,
              JCOEFPTR coef_block, JSAMPARRAY output_buf,
              JDIMENSION output_col)
{
  int dcval;
