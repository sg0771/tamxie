...
GLOBAL(boolean)
moz_jpeg_c_bool_param_supported (const j_compress_ptr cinfo, J_BOOLEAN_PARAM param)
{
  switch (param) {
...
GLOBAL(void)
moz_jpeg_c_set_bool_param (j_compress_ptr cinfo, J_BOOLEAN_PARAM param,
                       boolean value)
{
  switch(param) {
  case JBOOLEAN_OPTIMIZE_SCANS:
...
GLOBAL(boolean)
moz_jpeg_c_get_bool_param (const j_compress_ptr cinfo, J_BOOLEAN_PARAM param)
{
  switch(param) {
  case JBOOLEAN_OPTIMIZE_SCANS:
...
GLOBAL(boolean)
moz_jpeg_c_float_param_supported (const j_compress_ptr cinfo, J_FLOAT_PARAM param)
{
  switch (param) {
...
GLOBAL(void)
moz_jpeg_c_set_float_param (j_compress_ptr cinfo, J_FLOAT_PARAM param, float value)
{
  switch (param) {
  case JFLOAT_LAMBDA_LOG_SCALE1:
...
GLOBAL(float)
moz_jpeg_c_get_float_param (const j_compress_ptr cinfo, J_FLOAT_PARAM param)
{
  switch (param) {
  case JFLOAT_LAMBDA_LOG_SCALE1:
...
GLOBAL(boolean)
moz_jpeg_c_int_param_supported (const j_compress_ptr cinfo, J_INT_PARAM param)
{
  switch (param) {
...
GLOBAL(void)
moz_jpeg_c_set_int_param (j_compress_ptr cinfo, J_INT_PARAM param, int value)
{
  switch (param) {
  case JINT_COMPRESS_PROFILE:
    switch (value) {
...
GLOBAL(int)
moz_jpeg_c_get_int_param (const j_compress_ptr cinfo, J_INT_PARAM param)
{
  switch (param) {
  case JINT_COMPRESS_PROFILE:
