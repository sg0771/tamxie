...
/* 2:1 vertical sampling case: may need a spare row. */
{
  ...
  if (upsample->spare_full) {
    ...
    moz_jcopy_sample_rows(&upsample->spare_row, 0, output_buf + *out_row_ctr, 0, 1,
                      size);
    num_rows = 1;
    upsample->spare_full = FALSE;
  } else {
...
GLOBAL(void)
moz_jinit_merged_upsampler(j_decompress_ptr cinfo)
{
