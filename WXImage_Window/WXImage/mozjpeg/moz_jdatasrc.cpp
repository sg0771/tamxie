...
GLOBAL(void)
moz_jpeg_stdio_src(j_decompress_ptr cinfo, FILE *infile)
{
  my_src_ptr src;
  ...
  src->pub.resync_to_restart = moz_jpeg_resync_to_restart; /* use default method */
...
GLOBAL(void)
moz_jpeg_mem_src(j_decompress_ptr cinfo, const unsigned char *inbuffer,
             unsigned long insize)
{
  ...
  src->resync_to_restart = moz_jpeg_resync_to_restart; /* use default method */
