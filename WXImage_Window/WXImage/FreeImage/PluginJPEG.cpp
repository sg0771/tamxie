...
//add By Tam
//2023.01.27
extern BOOL  mozjpeg_Save(FreeImageIO* io, FIBITMAP* dib, fi_handle handle, int page, int flags, void* data);
...
Save(FreeImageIO *io, FIBITMAP *dib, fi_handle handle, int page, int flags, void *data) {
	...
	if (flags > 100) {
		...
		//add by Tam
		//2023.01.27
		return mozjpeg_Save(io, dib, handle, page, flags - 100, data);
	}
