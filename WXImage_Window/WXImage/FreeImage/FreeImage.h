...
FI_STRUCT (FIBITMAP) { 
	...
	FIMEMORY *m_stream;
	FREE_IMAGE_FORMAT m_srcFormat;//ԭʼͼ���ʽ
	int m_bSrcCMYK;//ԭʼͼ���Ƿ�CMYK
};
...
// Message output functions -------------------------------------------------
 ...
 void  FreeImage_OutputMessageProc(int fif, const char* fmt, ...); //�ڲ�log

typedef void ( *FreeImage_OutputMessageFunction)(FREE_IMAGE_FORMAT fif, const char *msg); 
 void  FreeImage_SetOutputMessage(FreeImage_OutputMessageFunction omf);  //�O��log���{
