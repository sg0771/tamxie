#ifndef _WEBRTC_AGC_H_
#define _WEBRTC_AGC_H_
...
typedef struct
{
    short targetLevelDbfs;   // default 3 (-3 dBOv)
    short compressionGaindB; // default 9 dB
    unsigned char limiterEnable;     // default kAgcTrue (on)
} WebRtcAgc_config_t;
