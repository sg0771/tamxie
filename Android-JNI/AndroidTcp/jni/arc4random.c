 ...
 */
#ifndef _ARC4_RANDOM_C_
#define _ARC4_RANDOM_C_
...
#if 1
static inline  void
event_arc4random_addrandom(const unsigned char *dat, int datlen)
{
	int j;
	_ARC4_LOCK();
	if (!rs_initialized)
...
#if 1
static inline  ARC4RANDOM_UINT32
event_arc4random(void)
{
...
static inline void event_arc4random_buf(void *_buf, size_t n)
{
 ...
 */
static inline  unsigned int
event_arc4random_uniform(unsigned int upper_bound)
{
