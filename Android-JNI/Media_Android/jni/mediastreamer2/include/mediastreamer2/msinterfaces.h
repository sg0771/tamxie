...
#if V2_PHONE_SUPPORT
typedef struct _VideoDisplayArea VideoDisplayArea;
#define MS_VIDEO_DISPLAY_SET_VIDEO_DISPLAY_AREA \
	MS_FILTER_METHOD(MSFilterVideoDisplayInterface, 13, VideoDisplayArea*)
#endif
/**
