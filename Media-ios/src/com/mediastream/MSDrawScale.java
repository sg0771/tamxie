...
//=============================================================================
	...
	public native void  xDraw(int handle, Surface surface, byte []buf, int dx, int dy, int scale);
...
//=============================================================================
	...
	public void Draw(byte []buf, int dx, int dy, float f){
		if(m_handle != 0){
			int scale = (int)(100 * f);
			xDraw(m_handle, m_view.getHolder().getSurface(), buf, dx, dy, scale);
		}
	}
	public void Close(){
		if(m_handle != 0){
