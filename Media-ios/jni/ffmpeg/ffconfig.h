...
#define FFMPEG_CONFIGURATION "--prefix='F:/ffmpeg' --arch=arm --target-os=linux --cross-prefix=arm-eabi- --enable-static --disable-shared --disable-asm --extra-cflags=' -I$ARM_INC -fPIC -DANDROID -fpic -mthumb-interwork -ffunction-sections -funwind-tables -fstack-protector -fno-short-enums -mfloat-abi=softfp -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__ -Wno-psabi -mtune=xscale -march=armv7-a -mfpu=neon -msoft-float -Os -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -DANDROID -Wa,--noexecstack -MMD -MP' --extra-ldflags='-nostdlib -Bdynamic -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,nocopyreloc -Wl,-soname,/system/lib/libz.so -Wl,-rpath-link=$ARM_LIB,-dynamic-linker=/system/bin/linker -L$ARM_LIB -nostdlib -ldl -lgcc -lc' --disable-everything --enable-decoder=h264 --disable-ffmpeg --disable-ffplay --disable-avformat --disable-ffprobe --disable-avdevice --disable-doc --disable-debug --disable-logging --disable-avfilter --disable-stripping --disable-network --disable-mpegaudio-hp --disable-swscale-alpha --disable-swscale"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define FFMPEG_DATADIR "F:/ffmpeg/share/ffmpeg"
#define CC_TYPE "gcc"
