...
#if V2_PHONE_SUPPORT 
#define MS_FILTER_RESET_CODEC MS_FILTER_BASE_METHOD_NO_ARG(29)
#define MS_RTP_RECV_SET_PARTNER_INDEX MS_FILTER_BASE_METHOD(30,int)
#define MS_RTP_RECV_GET_PARTNER_NUMBER MS_FILTER_BASE_METHOD(31,void*)
#define MS_FILTER_FIND_STREAM_INFO MS_FILTER_BASE_METHOD(32,void*)
#define MS_FILTER_GET_VIDEO_PAYLOAD MS_FILTER_BASE_METHOD(33,void*) 
#define MS_FILTER_GET_AUDIO_PAYLOAD MS_FILTER_BASE_METHOD(34,void*) 
#define MS_RTP_RECV_GET_CURRENT_SSRC MS_FILTER_BASE_METHOD(35,void*)
#define MS_FILTER_SET_GRAPH_READY MS_FILTER_BASE_METHOD(36,int)
#define MS_FILTER_SET_PUNCH_MODE  MS_FILTER_BASE_METHOD(37,int)
#define MS_FILTER_SEND_V2_P2P_RESP  MS_FILTER_BASE_METHOD(38,int)
#define MS_FILTER_SET_V2_P2P_RESP_RECEIVED  MS_FILTER_BASE_METHOD(39,int)
#define MS_RTP_RECV_GET_PARTNER_SSRC MS_FILTER_BASE_METHOD(40,int)
#define MS_VIDEO_DECODER_DISABLE__DECODER MS_FILTER_BASE_METHOD(41,int)
#define MS_VIDEO_DECODER_ENABLE_DECODER MS_FILTER_BASE_METHOD(42,int)
#define MS_VIDEO_DECODER_PAUSE_DECODER MS_FILTER_BASE_METHOD(43,int)
#define MS_VIDEO_DECODER_RESUME_DECODER MS_FILTER_BASE_METHOD(44,int)
#define MS_FILTER_SET_BYPASS_MODE MS_FILTER_BASE_METHOD(45,int)
