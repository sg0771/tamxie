...
public:
  ...
  {
    unsigned int col;
    uint8_t* c = reinterpret_cast<uint8_t*>(&col);

    c[0]=static_cast<uint8_t>(color.b*255);
    c[1]=static_cast<uint8_t>(color.g*255);
    c[2]=static_cast<uint8_t>(color.r*255);
    c[3]=255;
