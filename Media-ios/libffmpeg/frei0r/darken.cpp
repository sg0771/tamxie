...
class darken : public frei0r::mixer2
{
public:
  darken(unsigned int width, unsigned int height)
  {
  }

  /**
   *
   * Perform a darken operation between sources in1 and in2, using
