...
uint8_t *Rplani,*Gplani,*Bplani,*Rplano,*Gplano,*Bplano;
} inst;
...
in->Rplani=calloc(width*height,sizeof(uint8_t));
in->Gplani=calloc(width*height,sizeof(uint8_t));
in->Bplani=calloc(width*height,sizeof(uint8_t));
in->Rplano=calloc(width*height,sizeof(uint8_t));
in->Gplano=calloc(width*height,sizeof(uint8_t));
in->Bplano=calloc(width*height,sizeof(uint8_t));
