...
static frei0r::construct<bluescreen0r> plugin_bluescreen0r("bluescreen0r", "Color to alpha (blit SRCALPHA)", "Hedde Bosman",0,3,F0R_COLOR_MODEL_RGBA8888);

filter_dest_cpp(bluescreen0r)