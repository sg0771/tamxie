...
static void f0r_get_plugin_info(f0r_plugin_info_t* tehRoxx0rInfo)
{
...
{
  int blocksize;
  tehRoxx0r_instance_t* inst = (tehRoxx0r_instance_t*)calloc(1, sizeof(*inst));
