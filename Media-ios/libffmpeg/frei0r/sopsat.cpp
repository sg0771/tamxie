...
public:
    ...
    SOPSat(unsigned int, unsigned int)
    {
        ...
        m_lutR = (uint8_t *) malloc(256*sizeof(char));
        m_lutG = (uint8_t *) malloc(256*sizeof(char));
        m_lutB = (uint8_t *) malloc(256*sizeof(char));
        m_lutA = (uint8_t *) malloc(256*sizeof(char));
        updateLUT();
