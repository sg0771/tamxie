...
typedef int (*interpp)(uint8_t*, int, int, float, float, uint8_t*);
...
static void remap(int wi, int hi, int wo, int ho, uint8_t *vhs, uint8_t *izs, float *map, uint8_t bgc, interpp interp)
{
	int i,j;
	float x,y;
...
//  bgc = background color
//  interp = kazalec na interpolacijsko funkcijo
static void remap32(int wi, int hi, int wo, int ho, uint8_t *vhs, uint8_t *izs, float *map, uint32_t bgc, interpp interp)
{
	int i,j;
	float x,y;
...
static int interpNNpr_b(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
...
//	x,y tocka, za katero izracuna interpolirano vrednost
//	*v interpolirana vrednost
static int interpNN_b(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
#ifdef TEST_XY_LIMITS
	if ((x<0)||(x>w)||(y<0)||(y>h)) return -1;
#endif
...
//	x,y tocka, za katero izracuna interpolirano vrednost
//	*v interpolirana vrednost
static int interpNN_b32(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
#ifdef TEST_XY_LIMITS
	if ((x<0)||(x>w)||(y<0)||(y>h)) return -1;
#endif
...
//	x,y tocka, za katero izracuna interpolirano vrednost
//	*v interpolirana vrednost
static int interpBL_b(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
	int m,n,k,l;
	float a,b;
...
//bilinearna interpolacija
//za byte (char) vrednosti  v packed color 32 bitnem formatu
static int interpBL_b32(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
...
//	x,y tocka, za katero izracuna interpolirano vrednost
//	*v interpolirana vrednost
static int interpBC_b(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
	int i,j,l,m,n;
	float k;
...
//bikubicna interpolacija  "smooth"
//za byte (char) vrednosti  v packed color 32 bitnem formatu
static int interpBC_b32(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
	int i,j,b,l,m,n;
	float k;
	float p[4],p1[4],p2[4],p3[4],p4[4];
...
static int interpBC2_b(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
	int i,k,l,m,n;
...
//!!! ODKOD SUM???  (ze po eni rotaciji v interp_test !!)
//!!! v defish tega suma ni???
static int interpBC2_b32(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
	int b,i,k,l,m,n,u;
	float pp,p[4],wx[4],wy[4],xx;
...
//	x,y tocka, za katero izracuna interpolirano vrednost
//	*v interpolirana vrednost
static int interpSP4_b(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
	int i,j,m,n;
	float pp,p[4],wx[4],wy[4],xx;
...
//spline 4x4 interpolacija
//za byte (char) vrednosti  v packed color 32 bitnem formatu
static int interpSP4_b32(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
	int i,j,m,n,b;
	float pp,p[4],wx[4],wy[4],xx;
...
static int interpSP6_b(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
	int i,j,m,n;
...
//!!! PAZI, TOLE NE DELA CISTO PRAV ???   belina se siri
//!!! zaenkrat sem dodal fudge factor...
static int interpSP6_b32(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
	int i,b,j,m,n;
	float pp,p[6],wx[6],wy[6],xx;
...
//	x,y tocka, za katero izracuna interpolirano vrednost
//	*v interpolirana vrednost
static int interpSC16_b(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
	int i,j,m,n;
...
//truncated sinc "lanczos" 16x16 interpolacija
//za byte (char) vrednosti  v packed color 32 bitnem formatu
static int interpSC16_b32(uint8_t *sl, int w, int h, float x, float y, uint8_t *v)
{
	int i,j,m,b,n;
	float pp,p[16],wx[16],wy[16],xx,xxx,x1;
