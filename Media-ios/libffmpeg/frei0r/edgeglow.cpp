                      ...
                      const uint32_t* in)
  {
    ...
    for (unsigned int y=1; y<height-1; ++y)
    {
      for (unsigned int x=1; x<width-1; ++x)
      {
        ...
        uint8_t *p1 = (uint8_t *)&in[(y-1)*width+(x-1)];
        uint8_t *p2 = (uint8_t *)&in[(y-1)*width+x];
        uint8_t *p3 = (uint8_t *)&in[(y-1)*width+(x+1)];
        uint8_t *p4 = (uint8_t *)&in[y*width+(x-1)];
        uint8_t *p6 = (uint8_t *)&in[y*width+(x+1)];
        uint8_t *p7 = (uint8_t *)&in[(y+1)*width+(x-1)];
        uint8_t *p8 = (uint8_t *)&in[(y+1)*width+x];
        uint8_t *p9 = (uint8_t *)&in[(y+1)*width+(x+1)];
        
        uint8_t *g = (uint8_t *)&out[y*width+x];
	...
	uint8_t *p5 = (uint8_t *)&in[y*width+x];
	...
	uint8_t l=(uint8_t) (((float)max+(float)min)/2.);
