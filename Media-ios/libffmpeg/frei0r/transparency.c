...
static void f0r_get_plugin_info(f0r_plugin_info_t* transparencyInfo)
{
...
{
  transparency_instance_t* inst = (transparency_instance_t*)calloc(1, sizeof(*inst));
