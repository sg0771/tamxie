...
static void meri_y(float_rgba *s, measure_stat *yy, int color, int x, int y, int w, int sx, int sy)
{
...
//x,y=position of the center of the group in pixels
//sx,sy=size of the group in pixels
static void meri_rgb(float_rgba *s, measure_stat  *r, measure_stat  *g, measure_stat  *b, int x, int y, int w, int sx, int sy)
{
float nf;
int xp,yp;
float_rgba pix;
...
//x,y=position of the center of the group in pixels
//sx,sy=size of the group in pixels
static void meri_a(float_rgba *s, measure_stat  *a, int x, int y, int w, int sx, int sy)
{
float nf;
int xp,yp;
float_rgba pix;
...
//x,y=position of the center of the group in pixels
//sx,sy=size of the group in pixels
static void meri_uv(float_rgba *s, measure_stat  *u, measure_stat  *v, int color, int x, int y, int w, int sx, int sy)
{
