...
static  void draw_char(float_rgba *sl, int w, int h, int x, int y, uint8_t c, float_rgba col)
{
int i,j,z;
...
static  void forstr(float a, int p, int m, char *s)
{
float b;
char *p3=" %5.3f";
char *p3m="%+5.3f";
...
//m=sign  0=unsigned
//mm=1  print min/max
void izpis(char *str, char *lab, measure_stat  s, int u, int m, int mm)
{
...
int i,j,xp,yp;
char string[256];
measure_stat  yy,rr,gg,bb,aa,uu,vv;
