...
#define ECHO1(name, type, min, max)                                          \
...
ECHO1(dbl, double,  -1.0,      1.0      )
ECHO1(flt, float,   -1.0,      1.0      )
ECHO1(s16, int16_t, INT16_MIN, INT16_MAX)
ECHO1(s32, int32_t, INT32_MIN, INT32_MAX)
