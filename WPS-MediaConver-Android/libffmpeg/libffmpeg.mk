...
LOCAL_C_INCLUDES += $(ffmpeg-root-dir)/fdk-aac
LOCAL_C_INCLUDES += $(ffmpeg-root-dir)/openh264/include
LOCAL_C_INCLUDES += $(ffmpeg-root-dir)/lame
LOCAL_C_INCLUDES += $(ffmpeg-root-dir)/webp/src
LOCAL_C_INCLUDES += $(ffmpeg-root-dir)/libvpx
LOCAL_C_INCLUDES += $(ffmpeg-root-dir)/libopus
...
LOCAL_CFLAGS += -D__func__= -D__endfunc__=
LOCAL_ASFLAGS += -DHAVE_SECTION_ATTRIBUTES=0

LOCAL_ASFLAGS += -DHAVE_AS_FUNC=0

#LOCAL_CFLAGS += -fno-integrated-as
#LOCAL_ASFLAGS += -fno-integrated-as

LOCAL_CFLAGS += -std=c99 -fomit-frame-pointer -fPIC -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize  -D__ANDROID=1 
LOCAL_SHORT_COMMANDS := true
LOCAL_MODULE := wxffmpeg

# 确保编译器和汇编器都知晓是位置无关代码
LOCAL_CFLAGS  += -fPIC -DCONFIG_PIC=1
LOCAL_ASFLAGS += -fPIC -DCONFIG_PIC=1
...
# 强制告诉 Clang 使用汇编预处理器
LOCAL_ASFLAGS   += -x assembler-with-cpp

LOCAL_SRC_FILES +=libavcodec/arm/aacpsdsp_init_arm.c  \
...
# 针对 arm64-v8a 的修正
LOCAL_ASMFLAGS += -march=armv8-a -DPIC=1 -fPIC -DCONFIG_PIC=1 -D__64BIT__
LOCAL_CFLAGS   += -march=armv8-a -DPIC=1 -fPIC -DCONFIG_PIC=1
# 建议显式添加汇编预处理标志
LOCAL_ASFLAGS  += -x assembler-with-cpp
...
libswscale/aarch64/yuv2rgb_neon.S \ libavfilter/aarch64/vf_nlmeans_init.c \
...
libavformat/alvdec.c \
libavformat/alvenc.c \
libavformat/amr.c \
libavformat/anm.c \
libavformat/apc.c \
libavformat/ape.c \
...
#extern libs
LOCAL_SRC_FILES +=libavcodec/libopenh264.c   libavcodec/libopenh264enc.c   libavcodec/libmp3lame.c \
libavcodec/libwebpenc.c libavcodec/libwebpenc_common.c libavcodec/libwebpenc_animencoder.c  \
libavcodec/libvpx.c libavcodec/libvpxenc.c libavcodec/libvpxdec.c\
libavcodec/libopus.c libavcodec/libopusenc.c libavcodec/libopusdec.c
