...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --enable-cross-compile --enable-runtime-cpudetect --disable-doc --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-avdevice --enable-static --disable-shared --disable-demuxer=matroska_haali --arch=arm64 --cross-prefix=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android- --sysroot=/android-ndk-r14b/platforms/android-21/arch-arm64 --enable-neon --prefix=arm64-lib
prefix=arm64-lib
...
INTRINSICS=neon
EXTERN_PREFIX=
CC=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-gcc
CXX=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-g++
AS=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-gcc
OBJCC=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-gcc
LD=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-gcc
DEPCC=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-ar
ARFLAGS=rcD
AR_O=$@
AR_CMD=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-ar
NM_CMD=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-nm -g
RANLIB=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-ranlib -D
STRIP=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-strip
STRIPTYPE=direct
NVCC=nvcc
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/android-ndk-r14b/platforms/android-21/arch-arm64 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
...
LD_PATH=-L
DLLTOOL=
WINDRES=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-windres
DEPWINDRES=/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64/bin/aarch64-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS=  --sysroot=/android-ndk-r14b/platforms/android-21/arch-arm64 -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
...
HOSTCCDEP=$(DEP$(1)) $(DEP$(1)FLAGS) $($(1)DEP_FLAGS) $< 2>/dev/null | sed -e "/^\#.*/d" -e "s,^[[:space:]]*$(@F),$(@D)/$(@F)," > $(@:.o=.d)
HOSTCCDEP_FLAGS=-MM
HOSTCC_DEPFLAGS=
HOSTCC_C=-c
HOSTCC_O=-o $@
...
!CONFIG_MATROSKA_HAALI_DEMUXER=yes
