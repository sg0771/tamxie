...
extern void vp9_filter_by_weight8x8(const uint8_t *src, int src_stride, uint8_t *dst,
                               int dst_stride, int src_weight);
...
extern void vp9_filter_by_weight16x16(const uint8_t *src, int src_stride,
                                 uint8_t *dst, int dst_stride, int src_weight);
