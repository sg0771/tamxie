...
static  int small_diamond_search(MpegEncContext * s, int *best, int dmin,
...
static  int diamond_search(MpegEncContext * s, int *best, int dmin,
                                       int src_index, int ref_index, const int penalty_factor,
                                       int size, int h, int flags){
    MotionEstContext * const c= &s->me;
    if(c->dia_size==-1)
...
/**
   ...
   optimal mv.
 */
static  int epzs_motion_search_internal(MpegEncContext * s, int *mx_ptr, int *my_ptr,
