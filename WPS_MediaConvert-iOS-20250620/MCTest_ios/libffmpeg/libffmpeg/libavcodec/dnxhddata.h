...
static  uint64_t ff_dnxhd_check_header_prefix_hr(uint64_t prefix)
{
...
static  uint64_t ff_dnxhd_check_header_prefix(uint64_t prefix)
{
...
static  uint64_t ff_dnxhd_parse_header_prefix(const uint8_t *buf)
{
