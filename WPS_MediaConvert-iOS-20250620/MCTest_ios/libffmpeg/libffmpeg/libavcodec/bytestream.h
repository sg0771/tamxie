...
static  unsigned int bytestream2_get_bytes_left_p(PutByteContext *p)
{
...
static  int bytestream2_seek(GetByteContext *g,
                                             int offset,
                                             int whence)
{
    switch (whence) {
...
static  int bytestream2_seek_p(PutByteContext *p,
                                               int offset,
                                               int whence)
{
    p->eof = 0;
