...
static  int fetch_diagonal_mv(const H264Context *h, H264SliceContext *sl,
                                              const int16_t **C,
 ...
 */
static  void pred_motion(const H264Context *const h,
                                         H264SliceContext *sl,
                                         int n,
 ...
 * @param my the y component of the predicted motion vector
 */
static  void pred_16x8_motion(const H264Context *const h,
                                              H264SliceContext *sl,
 ...
 * @param my the y component of the predicted motion vector
 */
static  void pred_8x16_motion(const H264Context *const h,
                                              H264SliceContext *sl,
                                              int n, int list, int ref,
                                              int *const mx, int *const my)
{
...
static  void pred_pskip_motion(const H264Context *const h,
                                               H264SliceContext *sl)
{
