...
static  void fdct_col_##cpu(const int16_t *in, int16_t *out, int offset)\
{\
    __asm__ volatile (\
        #mov"      16(%0),  %%"#mm"0 \n\t" \
        #mov"      96(%0),  %%"#mm"1 \n\t" \
...
static  void fdct_row_sse2(const int16_t *in, int16_t *out)
{
    __asm__ volatile(
...
static  void fdct_row_mmxext(const int16_t *in, int16_t *out,
                                             const int16_t *table)
{
    __asm__ volatile (
        "pshufw    $0x1B, 8(%0), %%mm5 \n\t"
...
static  void fdct_row_mmx(const int16_t *in, int16_t *out, const int16_t *table)
{
