...
static  void setctx_2d(uint8_t *ptr, int w, int h,
...
static  int decode_coeffs(VP9TileData *td, int is8bitsperpixel)
{
    VP9Context *s = td->s;
    VP9Block *b = td->b;
...
static  void mask_edges(uint8_t (*mask)[8][4], int ss_h, int ss_v,
