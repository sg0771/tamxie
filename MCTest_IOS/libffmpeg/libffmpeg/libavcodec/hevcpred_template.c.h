...
static  void FUNC(intra_pred)(HEVCContext *s, int x0, int y0,
...
static  void FUNC(pred_planar)(uint8_t *_src, const uint8_t *_top,
...
static  void FUNC(pred_angular)(uint8_t *_src,
                                                const uint8_t *_top,
                                                const uint8_t *_left,
