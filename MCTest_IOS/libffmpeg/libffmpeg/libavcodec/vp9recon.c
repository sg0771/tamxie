...
static  int check_intra_mode(VP9TileData *td, int mode, uint8_t **a,
...
static  void intra_recon(VP9TileData *td, ptrdiff_t y_off,
...
static  void mc_luma_unscaled(VP9TileData *td, vp9_mc_func (*mc)[2],
...
static  void mc_chroma_unscaled(VP9TileData *td, vp9_mc_func (*mc)[2],
...
static  void mc_luma_scaled(VP9TileData *td, vp9_scaled_mc_func smc,
                                            vp9_mc_func (*mc)[2],
                                            uint8_t *dst, ptrdiff_t dst_stride,
                                            const uint8_t *ref, ptrdiff_t ref_stride,
                                            ThreadFrame *ref_frame,
...
static  void mc_chroma_scaled(VP9TileData *td, vp9_scaled_mc_func smc,
                                              vp9_mc_func (*mc)[2],
                                              uint8_t *dst_u, uint8_t *dst_v,
                                              ptrdiff_t dst_stride,
                                              const uint8_t *ref_u, ptrdiff_t src_stride_u,
...
static  void inter_recon(VP9TileData *td, int bytesperpixel)
{
    VP9Context *s = td->s;
    VP9Block *b = td->b;
    int row = td->row, col = td->col;
