 ...
 */
static  int vpX_rac_is_end(VP56RangeCoder *c)
{
    return c->end <= c->buffer && c->bits >= 0;
}

static  unsigned int vp56_rac_renorm(VP56RangeCoder *c)
{
...
static  int vp56_rac_get_prob_branchy(VP56RangeCoder *c, int prob)
{
...
static  int vp8_rac_get(VP56RangeCoder *c)
{
...
static  int vp8_rac_get_tree(VP56RangeCoder *c, const int8_t (*tree)[2],
                                   const uint8_t *probs)
{
    int i = 0;
