...
static  void vc1_h_overlap_filter(VC1Context *v, int16_t (*left_block)[64],
...
static  void vc1_v_overlap_filter(VC1Context *v, int16_t (*top_block)[64],
...
static  void vc1_i_h_loop_filter(VC1Context *v, uint8_t *dest,
...
static  void vc1_i_v_loop_filter(VC1Context *v, uint8_t *dest,
...
static  void vc1_p_h_loop_filter(VC1Context *v, uint8_t *dest, uint32_t *cbp,
...
static  void vc1_p_v_loop_filter(VC1Context *v, uint8_t *dest, uint32_t *cbp,
                                                 uint8_t *is_intra, int16_t (*mv)[2], uint8_t *mv_f,
                                                 int *ttblk, uint32_t flags, int block_num)
{
    MpegEncContext *s  = &v->s;
...
static  void vc1_p_h_intfr_loop_filter(VC1Context *v, uint8_t *dest, int *ttblk,
...
static  void vc1_p_v_intfr_loop_filter(VC1Context *v, uint8_t *dest, int *ttblk,
                                                       uint32_t flags, uint8_t fieldtx, int block_num)
{
    MpegEncContext *s  = &v->s;
    int pq = v->pq;
...
static  void vc1_b_h_intfi_loop_filter(VC1Context *v, uint8_t *dest, uint32_t *cbp,
                                                       int *ttblk, uint32_t flags, int block_num)
{
    MpegEncContext *s  = &v->s;
    int pq = v->pq;
...
static  void vc1_b_v_intfi_loop_filter(VC1Context *v, uint8_t *dest, uint32_t *cbp,
                                                       int *ttblk, uint32_t flags, int block_num)
{
    MpegEncContext *s  = &v->s;
    int pq = v->pq;
